...
@section('content')
    ...
    <section class="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div class="relative z-10 p-6">
            ...
            <p class="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8 animate-fade-in-up">
                A Millennium Network é a sua conexão direta com mentores, recrutadores e o próximo nível do futebol
                profissional.
            </p>
        </div>
    </section>
    ...
    <section class="py-20 bg-zinc-950">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-gray-400 mb-12 max-w-2xl mx-auto">Ferramentas e conexões para transformar potencial em realidade.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-zinc-900 p-8 border border-zinc-800">
                    ...
                    <p class="text-gray-300">Crie um perfil profissional completo com vídeos, estatísticas e histórico. Seja
                        encontrado por olheiros de todo o mundo.</p>
                </div>

                <div class="bg-zinc-900 p-8 border border-zinc-800">
                    <h3 class="text-2xl font-bold text-green-400 mb-3">Mentorias 1-a-1</h3>
                    <p class="text-gray-300">Agende sessões online com mentores experientes, ex-jogadores e profissionais da
                        área para acelerar seu desenvolvimento.</p>
                </div>

                <div class="bg-zinc-900 p-8 border border-zinc-800">
                    <h3 class="text-2xl font-bold text-green-400 mb-3">Lives e Conteúdo</h3>
                    <p class="text-gray-300">Acesse uma biblioteca de lives, workshops e análises táticas para aprimorar seu
                        conhecimento dentro e fora de campo.</p>
                </div>
